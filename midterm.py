...
Author:              Paul Lindberg & Tynan Matthews
Class:               DAT-330-02
Assignment:          KNN Tutorial Assignment
Date Assigned:       10/17/2019
Due Date:            10/24/2019 9:00 AM

Description:
Takes in data files containing clinical and mutation data for various
cancer patients. Moves this data into a dataframe, then transposes the dataframe
to make it easier to analyze. Takes the dataframe and runs it through sklearn
train test and split, and puts the following training and testing data through
sklearn knn and decision trees. Takes the predicted data from both of these
functions, and compares to the actual data to see what percentage is right.

Champlain College CSI-235, Spring 2018
The following code was written by by Paul Lindberg & Tynan Matthews
(paul.lindberg@mymail.champlain.edu & tynan.matthews@mymail.champlain.edu)
"""
